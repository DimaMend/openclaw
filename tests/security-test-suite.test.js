...
import { authorizeGatewayConnect, resolveGatewayAuth } from "../src/gateway/auth.js";
...
void test("Rate Limiting - allows initial requests", () => {
  clearRateLimitCache();
...
void test("Rate Limiting - blocks after 5 failures", () => {
  clearRateLimitCache();
...
void test("Rate Limiting - independent per IP", () => {
  clearRateLimitCache();
...
void test("Password Hashing - generates valid hash", async () => {
...
void test("Password Hashing - verification works", async () => {
...
void test("Password Hashing - same password = different hashes (salt)", async () => {
...
void test("Password Hashing - detects format correctly", () => {
...
void test("Password Hashing - migration is idempotent", async () => {
...
void test("Auth Integration - rate limiting blocks auth attempts", async () => {
  clearRateLimitCache();
...
void test("Auth Integration - plain text password still works (backward compat)", async () => {
...
void test("Security Config - resolveGatewayAuth detects mode correctly", () => {
...
void test("Security Config - environment variable override", () => {
...
void test("Performance - rate limit check is fast", () => {
  clearRateLimitCache();
...
void test("Edge Case - empty IP address", () => {
  clearRateLimitCache();
...
void test("Edge Case - IPv6 addresses", () => {
  clearRateLimitCache();
...
void test("Edge Case - very long password", async () => {
...
void test("Edge Case - special characters in password", async () => {
...
void test("Edge Case - unicode in password", async () => {
