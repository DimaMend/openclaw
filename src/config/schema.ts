...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.enabled":
    "Enable the web_search tool (uses Atlas when available; otherwise requires a provider API key).",
  "tools.web.search.provider": 'Search provider ("brave", "perplexity", or "atlas").',
