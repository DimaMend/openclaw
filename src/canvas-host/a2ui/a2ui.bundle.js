...
var n$12 = class {
  constructor(t$7, e$14, o$15) {
    if (((this._$cssResult$ = !0), o$15 !== s$8))
      throw Error(
  ...
  get styleSheet() {
    ...
    if (e$13 && void 0 === t$7) {
      ...
      (e$14 && (t$7 = o$14.get(s$9)),
        void 0 === t$7 &&
          ((this.o = t$7 = new CSSStyleSheet()).replaceSync(this.cssText),
          e$14 && o$14.set(s$9, t$7)));
    }
    return t$7;
  }
  toString() {
...
const r$11 = (t$7) =>
    new n$12("string" == typeof t$7 ? t$7 : t$7 + "", void 0, s$8),
  i$9 = (t$7, ...e$14) => {
    const o$15 =
      1 === t$7.length
        ? t$7[0]
  ...
  S$1 = (s$9, o$15) => {
    if (e$13)
      s$9.adoptedStyleSheets = o$15.map((t$7) =>
        t$7 instanceof CSSStyleSheet ? t$7 : t$7.styleSheet,
      );
    else
      for (const e$14 of o$15) {
        const o$16 = document.createElement("style"),
          n$13 = t$6.litNonce;
        (void 0 !== n$13 && o$16.setAttribute("nonce", n$13),
          (o$16.textContent = e$14.cssText),
          s$9.appendChild(o$16));
      }
  },
  c$6 = e$13
    ? (t$7) => t$7
    : (t$7) =>
        t$7 instanceof CSSStyleSheet
          ? ((t$8) => {
              let e$14 = "";
  ...
  u$3 = {
    toAttribute(t$7, s$9) {
      switch (s$9) {
        ...
        case Object:
        case Array:
          t$7 = null == t$7 ? t$7 : JSON.stringify(t$7);
      }
      return t$7;
    },
...
var y$1 = class extends HTMLElement {
  ...
  static createProperty(t$7, s$9 = b$1) {
    if (
      (s$9.state && (s$9.attribute = !1),
      this._$Ei(),
      this.prototype.hasOwnProperty(t$7) &&
        ((s$9 = Object.create(s$9)).wrapped = !0),
      this.elementProperties.set(t$7, s$9),
      !s$9.noAccessor)
    ) {
      const i$10 = Symbol(),
        h$7 = this.getPropertyDescriptor(t$7, i$10, s$9);
  ...
  static _$Ei() {
    ...
    const t$7 = n$11(this);
    (t$7.finalize(),
      void 0 !== t$7.l && (this.l = [...t$7.l]),
      (this.elementProperties = new Map(t$7.elementProperties)));
  }
  static finalize() {
    ...
    if (
      ...
      const t$8 = this.properties,
        s$9 = [...r$10(t$8), ...o$13(t$8)];
    ...
    if (null !== t$7) {
      ...
      if (void 0 !== s$9)
        for (const [t$8, i$10] of s$9) this.elementProperties.set(t$8, i$10);
    }
    this._$Eh = new Map();
  ...
  _$Ev() {
    ((this._$ES = new Promise((t$7) => (this.enableUpdating = t$7))),
      (this._$AL = new Map()),
      this._$E_(),
      this.requestUpdate(),
      this.constructor.l?.forEach((t$7) => t$7(this)));
  }
  addController(t$7) {
    ((this._$EO ??= new Set()).add(t$7),
      void 0 !== this.renderRoot && this.isConnected && t$7.hostConnected?.());
  }
  ...
  _$E_() {
    const t$7 = new Map(),
      s$9 = this.constructor.elementProperties;
    for (const i$10 of s$9.keys())
      this.hasOwnProperty(i$10) &&
        (t$7.set(i$10, this[i$10]), delete this[i$10]);
  ...
  connectedCallback() {
    ((this.renderRoot ??= this.createRenderRoot()),
      ...
      this._$EO?.forEach((t$7) => t$7.hostConnected?.()));
  }
  enableUpdating(t$7) {}
  ...
  _$ET(t$7, s$9) {
    const i$10 = this.constructor.elementProperties.get(t$7),
      e$14 = this.constructor._$Eu(t$7, i$10);
    if (void 0 !== e$14 && !0 === i$10.reflect) {
      const h$7 = (
        void 0 !== i$10.converter?.toAttribute ? i$10.converter : u$3
      ).toAttribute(s$9, i$10.type);
      ((this._$Em = t$7),
        null == h$7 ? this.removeAttribute(e$14) : this.setAttribute(e$14, h$7),
        (this._$Em = null));
    }
  }
  _$AK(t$7, s$9) {
    const i$10 = this.constructor,
      e$14 = i$10._$Eh.get(t$7);
    if (void 0 !== e$14 && this._$Em !== e$14) {
      const t$8 = i$10.getPropertyOptions(e$14),
        h$7 =
          "function" == typeof t$8.converter
            ? { fromAttribute: t$8.converter }
            : void 0 !== t$8.converter?.fromAttribute
              ? t$8.converter
              : u$3;
      this._$Em = e$14;
  ...
  requestUpdate(t$7, s$9, i$10, e$14 = !1, h$7) {
    if (void 0 !== t$7) {
      ...
      if (
        (!1 === e$14 && (h$7 = this[t$7]),
        (i$10 ??= r$12.getPropertyOptions(t$7)),
        !(
          (i$10.hasChanged ?? f$3)(h$7, s$9) ||
          (i$10.useDefault &&
            i$10.reflect &&
            h$7 === this._$Ej?.get(t$7) &&
            !this.hasAttribute(r$12._$Eu(t$7, i$10)))
        ))
      )
        return;
      this.C(t$7, s$9, i$10);
  ...
  C(t$7, s$9, { useDefault: i$10, reflect: e$14, wrapped: h$7 }, r$12) {
    (i$10 &&
      !(this._$Ej ??= new Map()).has(t$7) &&
      (this._$Ej.set(t$7, r$12 ?? s$9 ?? this[t$7]),
      !0 !== h$7 || void 0 !== r$12)) ||
      (this._$AL.has(t$7) ||
        (this.hasUpdated || i$10 || (s$9 = void 0), this._$AL.set(t$7, s$9)),
      !0 === e$14 && this._$Em !== t$7 && (this._$Eq ??= new Set()).add(t$7));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t$8.size > 0)
        for (const [s$10, i$10] of t$8) {
          const { wrapped: t$9 } = i$10,
            e$14 = this[s$10];
          !0 !== t$9 ||
            this._$AL.has(s$10) ||
            void 0 === e$14 ||
            this.C(s$10, void 0, i$10, e$14);
        }
    }
    let t$7 = !1;
    const s$9 = this._$AL;
    try {
      ((t$7 = this.shouldUpdate(s$9)),
        t$7
          ? (this.willUpdate(s$9),
            this._$EO?.forEach((t$8) => t$8.hostUpdate?.()),
            this.update(s$9))
          : this._$EM());
    } catch (s$10) {
  ...
  willUpdate(t$7) {}
  _$AE(t$7) {
    (this._$EO?.forEach((t$8) => t$8.hostUpdated?.()),
      this.hasUpdated || ((this.hasUpdated = !0), this.firstUpdated(t$7)),
      this.updated(t$7));
  }
  _$EM() {
  ...
  update(t$7) {
    ((this._$Eq &&= this._$Eq.forEach((t$8) => this._$ET(t$8, this[t$8]))),
      this._$EM());
  }
  updated(t$7) {}
  firstUpdated(t$7) {}
...
const t$5 = globalThis,
  ...
  e$11 = s$7
    ? s$7.createPolicy("lit-html", { createHTML: (t$7) => t$7 })
    : void 0,
  h$5 = "$lit$",
  ...
  a = (t$7) =>
    null === t$7 || ("object" != typeof t$7 && "function" != typeof t$7),
  u$2 = Array.isArray,
  d$1 = (t$7) => u$2(t$7) || "function" == typeof t$7?.[Symbol.iterator],
  f$2 = "[ 	\n\f\r]",
...
function V(t$7, i$10) {
  if (!u$2(t$7) || !t$7.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return void 0 !== e$11 ? e$11.createHTML(i$10) : i$10;
}
const N = (t$7, i$10) => {
  const s$9 = t$7.length - 1,
    e$14 = [];
  let n$13,
    l$5 = 2 === i$10 ? "<svg>" : 3 === i$10 ? "<math>" : "",
    c$7 = v$1;
  for (let i$11 = 0; i$11 < s$9; i$11++) {
    ...
    for (
      ;
      f$4 < s$10.length &&
      ((c$7.lastIndex = f$4), (u$4 = c$7.exec(s$10)), null !== u$4);
    )
      ((f$4 = c$7.lastIndex),
        c$7 === v$1
          ? "!--" === u$4[1]
            ...
            : void 0 !== u$4[1]
              ? (c$7 = m$2)
              : void 0 !== u$4[2]
                ? (y.test(u$4[2]) && (n$13 = RegExp("</" + u$4[2], "g")),
                  (c$7 = p$1))
                : void 0 !== u$4[3] && (c$7 = p$1)
          : c$7 === p$1
            ? ">" === u$4[0]
              ? ((c$7 = n$13 ?? v$1), (d$3 = -1))
              : void 0 === u$4[1]
    ...
    l$5 +=
      c$7 === v$1
        ...
        : d$3 >= 0
          ? (e$14.push(a$2),
            s$10.slice(0, d$3) + h$5 + s$10.slice(d$3) + o$12 + x$1)
...
var S = class S {
  constructor({ strings: t$7, _$litType$: i$10 }, e$14) {
    ...
    const u$4 = t$7.length - 1,
      ...
      [f$4, v$2] = N(t$7, i$10);
    if (
      ((this.el = S.createElement(f$4, e$14)),
    ...
    for (; null !== (r$12 = P.nextNode()) && d$3.length < u$4; ) {
      if (1 === r$12.nodeType) {
        ...
        if (y.test(r$12.tagName)) {
          const t$8 = r$12.textContent.split(o$12),
            i$11 = t$8.length - 1;
          if (i$11 > 0) {
            r$12.textContent = s$7 ? s$7.emptyScript : "";
            for (let s$9 = 0; s$9 < i$11; s$9++)
              (r$12.append(t$8[s$9], c$4()),
                P.nextNode(),
                d$3.push({
                  type: 2,
                  index: ++l$5,
        ...
        if (r$12.data === n$10)
          ...
          let t$8 = -1;
          for (; -1 !== (t$8 = r$12.data.indexOf(o$12, t$8 + 1)); )
            (d$3.push({
              type: 7,
              index: l$5,
            }),
...
function M$1(t$7, i$10, s$9 = t$7, e$14) {
  ...
  return (
    h$7?.constructor !== o$15 &&
      (h$7?._$AO?.(!1),
      void 0 === o$15
        ? (h$7 = void 0)
        : ((h$7 = new o$15(t$7)), h$7._$AT(t$7, s$9, e$14)),
      void 0 !== e$14 ? ((s$9._$Co ??= [])[e$14] = h$7) : (s$9._$Cl = h$7)),
    void 0 !== h$7 && (i$10 = M$1(t$7, h$7._$AS(t$7, i$10.values), h$7, e$14)),
    i$10
  );
}
var R = class {
  ...
  u(t$7) {
    const {
      ...
      e$14 = (t$7?.creationScope ?? l$3).importNode(i$10, !0);
    P.currentNode = e$14;
    let h$7 = P.nextNode(),
      o$15 = 0,
      n$13 = 0,
    ...
    for (; void 0 !== r$12; ) {
      if (o$15 === r$12.index) {
        let i$11;
        (2 === r$12.type
          ? (i$11 = new k(h$7, h$7.nextSibling, this, t$7))
          : 1 === r$12.type
            ? (i$11 = new r$12.ctor(h$7, r$12.name, r$12.strings, this, t$7))
            : 6 === r$12.type && (i$11 = new Z(h$7, this, t$7)),
          this._$AV.push(i$11),
          (r$12 = s$9[++n$13]));
      }
  ...
  p(t$7) {
    let i$10 = 0;
    for (const s$9 of this._$AV)
      (void 0 !== s$9 &&
        (void 0 !== s$9.strings
          ? (s$9._$AI(t$7, s$9, i$10), (i$10 += s$9.strings.length - 2))
          : s$9._$AI(t$7[i$10])),
        i$10++);
  }
};
var k = class k {
  ...
  constructor(t$7, i$10, s$9, e$14) {
    ((this.type = 2),
      ...
      (this._$AM = s$9),
      (this.options = e$14),
      (this._$Cv = e$14?.isConnected ?? !0));
  }
  get parentNode() {
    let t$7 = this._$AA.parentNode;
    const i$10 = this._$AM;
    return (
      void 0 !== i$10 && 11 === t$7?.nodeType && (t$7 = i$10.parentNode), t$7
    );
  }
  get startNode() {
    return this._$AA;
  ...
  _$AI(t$7, i$10 = this) {
    ((t$7 = M$1(this, t$7, i$10)),
      a(t$7)
        ? t$7 === A || null == t$7 || "" === t$7
          ? (this._$AH !== A && this._$AR(), (this._$AH = A))
          : t$7 !== this._$AH && t$7 !== E && this._(t$7)
        : void 0 !== t$7._$litType$
          ? this.$(t$7)
          : void 0 !== t$7.nodeType
            ? this.T(t$7)
            : d$1(t$7)
  ...
  _(t$7) {
    (this._$AH !== A && a(this._$AH)
      ? (this._$AA.nextSibling.data = t$7)
      : this.T(l$3.createTextNode(t$7)),
      (this._$AH = t$7));
  }
  $(t$7) {
    const { values: i$10, _$litType$: s$9 } = t$7,
      e$14 =
        "number" == typeof s$9
          ? this._$AC(t$7)
          : (void 0 === s$9.el &&
              (s$9.el = S.createElement(V(s$9.h, s$9.h[0]), this.options)),
            s$9);
    if (this._$AH?._$AD === e$14) this._$AH.p(i$10);
    else {
      const t$8 = new R(e$14, this),
        s$10 = t$8.u(this.options);
  ...
  k(t$7) {
    ...
    let s$9,
      e$14 = 0;
    for (const h$7 of t$7)
      (e$14 === i$10.length
        ? i$10.push(
            (s$9 = new k(this.O(c$4()), this.O(c$4()), this, this.options)),
          )
        : (s$9 = i$10[e$14]),
        s$9._$AI(h$7),
        e$14++);
    e$14 < i$10.length &&
      (this._$AR(s$9 && s$9._$AB.nextSibling, e$14), (i$10.length = e$14));
  }
...
var H = class {
  ...
  constructor(t$7, i$10, s$9, e$14, h$7) {
    ((this.type = 1),
      ...
      (this._$AM = e$14),
      (this.options = h$7),
      s$9.length > 2 || "" !== s$9[0] || "" !== s$9[1]
        ? ((this._$AH = Array(s$9.length - 1).fill(new String())),
          (this.strings = s$9))
        : (this._$AH = A));
  }
  _$AI(t$7, i$10 = this, s$9, e$14) {
    ...
    let o$15 = !1;
    if (void 0 === h$7)
      ((t$7 = M$1(this, t$7, i$10, 0)),
        (o$15 = !a(t$7) || (t$7 !== this._$AH && t$7 !== E)),
        o$15 && (this._$AH = t$7));
    else {
      const e$15 = t$7;
      let n$13, r$12;
      for (t$7 = h$7[0], n$13 = 0; n$13 < h$7.length - 1; n$13++)
        ((r$12 = M$1(this, e$15[s$9 + n$13], i$10, n$13)),
          r$12 === E && (r$12 = this._$AH[n$13]),
          (o$15 ||= !a(r$12) || r$12 !== this._$AH[n$13]),
          r$12 === A
            ? (t$7 = A)
            : t$7 !== A && (t$7 += (r$12 ?? "") + h$7[n$13 + 1]),
          (this._$AH[n$13] = r$12));
    }
  ...
  j(t$7) {
    t$7 === A
      ...
      : this.element.setAttribute(this.name, t$7 ?? "");
  }
};
...
var z = class extends H {
  ...
  _$AI(t$7, i$10 = this) {
    ...
    const s$9 = this._$AH,
      e$14 =
        (t$7 === A && s$9 !== A) ||
        t$7.capture !== s$9.capture ||
        t$7.once !== s$9.once ||
        t$7.passive !== s$9.passive,
      h$7 = t$7 !== A && (s$9 === A || e$14);
    (e$14 && this.element.removeEventListener(this.name, this, s$9),
      h$7 && this.element.addEventListener(this.name, this, t$7),
      (this._$AH = t$7));
  }
  handleEvent(t$7) {
    "function" == typeof this._$AH
      ? this._$AH.call(this.options?.host ?? this.element, t$7)
      : this._$AH.handleEvent(t$7);
  }
};
var Z = class {
...
const D = (t$7, i$10, s$9) => {
  ...
  if (void 0 === h$7) {
    ...
    e$14._$litPart$ = h$7 = new k(
      i$10.insertBefore(c$4(), t$8),
      t$8,
      void 0,
      s$9 ?? {},
    );
...
var i$6 = class extends y$1 {
  ...
  update(t$7) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t$7),
      (this._$Do = D(r$12, this.renderRoot, this.renderOptions)));
  }
  connectedCallback() {
 ...
 */ const { I: t$3 } = j$1,
  i$4 = (o$15) => o$15,
  n$8 = (o$15) =>
    null === o$15 || ("object" != typeof o$15 && "function" != typeof o$15),
  e$9 = {
    HTML: 1,
    SVG: 2,
    MATHML: 3,
  ...
  l$2 = (o$15, t$7) =>
    void 0 === t$7 ? void 0 !== o$15?._$litType$ : o$15?._$litType$ === t$7,
  d = (o$15) => null != o$15?._$litType$?.h,
  c$3 = (o$15) => void 0 !== o$15?._$litDirective$,
  f$1 = (o$15) => o$15?._$litDirective$,
  r$8 = (o$15) => void 0 === o$15.strings,
  ...
  u$1 = (o$15, t$7, i$10 = o$15) => (o$15._$AI(t$7, i$10), o$15),
  m$1 = {},
  p = (o$15, t$7 = m$1) => (o$15._$AH = t$7),
  M = (o$15) => o$15._$AH,
  h$4 = (o$15) => {
...
const u = (e$14, s$9, t$7) => {
  ...
  c$2 = e$10(
    class extends i$5 {
      constructor(e$14) {
        if ((super(e$14), e$14.type !== t$4.CHILD))
      ...
      dt(e$14, s$9, t$7) {
        ...
        const l$5 = [],
          o$15 = [];
        let i$10 = 0;
        for (const s$10 of e$14)
          ((l$5[i$10] = r$12 ? r$12(s$10, i$10) : i$10),
            (o$15[i$10] = t$7(s$10, i$10)),
            i$10++);
        return {
          values: o$15,
          keys: l$5,
      ...
      update(s$9, [t$7, r$12, c$7]) {
        const d$3 = M(s$9),
          { values: p$3, keys: a$2 } = this.dt(t$7, r$12, c$7);
        ...
        for (; x$1 <= j$2 && k$1 <= w$1; )
          ...
          else if (h$7[x$1] === a$2[k$1])
            ((v$2[k$1] = u$1(d$3[x$1], p$3[k$1])), x$1++, k$1++);
          else if (h$7[j$2] === a$2[w$1])
            ((v$2[w$1] = u$1(d$3[j$2], p$3[w$1])), j$2--, w$1--);
          else if (h$7[x$1] === a$2[w$1])
            ((v$2[w$1] = u$1(d$3[x$1], p$3[w$1])),
              v(s$9, v$2[w$1 + 1], d$3[x$1]),
              x$1++,
              w$1--);
          else if (h$7[j$2] === a$2[k$1])
            ((v$2[k$1] = u$1(d$3[j$2], p$3[k$1])),
              v(s$9, d$3[x$1], d$3[j$2]),
              j$2--,
              k$1++);
          else if (
            (void 0 === m$3 &&
              ((m$3 = u(a$2, k$1, w$1)), (y$2 = u(h$7, x$1, j$2))),
            m$3.has(h$7[x$1]))
          )
            if (m$3.has(h$7[j$2])) {
              const e$14 = y$2.get(a$2[k$1]),
                t$8 = void 0 !== e$14 ? d$3[e$14] : null;
              if (null === t$8) {
                const e$15 = v(s$9, d$3[x$1]);
                (u$1(e$15, p$3[k$1]), (v$2[k$1] = e$15));
              } else
                ((v$2[k$1] = u$1(t$8, p$3[k$1])),
                  v(s$9, d$3[x$1], t$8),
                  (d$3[e$14] = null));
              k$1++;
...
var s$4 = class extends Event {
  constructor(s$9, t$7, e$14, o$15) {
    (super("context-request", {
      ...
      (this.context = s$9),
      (this.contextTarget = t$7),
      (this.callback = e$14),
      (this.subscribe = o$15 ?? !1));
  }
};
 ...
 */ var s$3 = class {
  constructor(t$7, s$9, i$10, h$7) {
    if (
      ...
      const t$8 = s$9;
      ((this.context = t$8.context),
        (this.callback = t$8.callback),
        (this.subscribe = t$8.subscribe ?? !1));
    } else
      ((this.context = s$9),
        (this.callback = i$10),
        (this.subscribe = h$7 ?? !1));
  ...
  dispatchRequest() {
    this.host.dispatchEvent(
      new s$4(this.context, this.host, this.t, this.subscribe),
    );
  }
};
...
var s$2 = class {
  ...
  constructor(s$9) {
    ((this.subscriptions = new Map()),
      (this.updateObservers = () => {
        for (const [s$10, { disposer: t$7 }] of this.subscriptions)
          s$10(this.o, t$7);
      }),
  ...
  addCallback(s$9, t$7, i$10) {
    ...
    this.subscriptions.has(s$9) ||
      this.subscriptions.set(s$9, {
        disposer: () => {
 ...
 */ var e$8 = class extends Event {
  constructor(t$7, s$9) {
    (super("context-provider", {
      ...
      (this.context = t$7),
      (this.contextTarget = s$9));
  }
};
var i$3 = class extends s$2 {
  constructor(s$9, e$14, i$10) {
    (super(void 0 !== e$14.context ? e$14.initialValue : i$10),
      (this.onContextRequest = (t$7) => {
        if (t$7.context !== this.context) return;
        const s$10 = t$7.contextTarget ?? t$7.composedPath()[0];
        s$10 !== this.host &&
          (t$7.stopPropagation(),
          this.addCallback(t$7.callback, s$10, t$7.subscribe));
      }),
      (this.onProviderRequest = (s$10) => {
        if (s$10.context !== this.context) return;
        if ((s$10.contextTarget ?? s$10.composedPath()[0]) === this.host)
          return;
        const e$15 = new Set();
        for (const [s$11, { consumerHost: i$11 }] of this.subscriptions)
          e$15.has(s$11) ||
            (e$15.add(s$11),
            i$11.dispatchEvent(new s$4(this.context, i$11, s$11, !0)));
        s$10.stopPropagation();
      }),
      (this.host = s$9),
      void 0 !== e$14.context
        ? (this.context = e$14.context)
        : (this.context = e$14),
 ...
 */ var t$2 = class {
    ...
    ((this.pendingContextRequests = new Map()),
      (this.onContextProvider = (t$7) => {
        ...
        for (const { elementRef: s$10, callbackRef: n$13 } of o$15) {
          const o$16 = s$10.deref(),
            c$7 = n$13.deref();
          void 0 === o$16 ||
            void 0 === c$7 ||
            o$16.dispatchEvent(new s$4(t$7.context, o$16, c$7, !0));
        }
      }),
      (this.onContextRequest = (e$14) => {
        if (!0 !== e$14.subscribe) return;
        const t$7 = e$14.contextTarget ?? e$14.composedPath()[0],
          s$9 = e$14.callback;
        ...
        (void 0 === n$13 && o$15.callbacks.set(t$7, (n$13 = new WeakSet())),
          n$13.has(s$9) ||
            (n$13.add(s$9),
            o$15.requests.push({
  ...
  attach(e$14) {
    (e$14.addEventListener("context-request", this.onContextRequest),
      e$14.addEventListener("context-provider", this.onContextProvider));
  }
  detach(e$14) {
    (e$14.removeEventListener("context-request", this.onContextRequest),
      e$14.removeEventListener("context-provider", this.onContextProvider));
  }
};
...
function merge(...classes) {
  ...
  for (const clazz of classes) {
    for (const [key, val] of Object.entries(clazz)) {
      ...
      const existingKeys = Object.keys(styles).filter((key$1) =>
...
const color = (src) => `
    ...
    ${src
      .map((key) => {
        ...
        for (let o$15 = 0.1; o$15 < 1; o$15 += 0.1) {
...
var A2uiMessageProcessor = class A2uiMessageProcessor {
  ...
  #resolvePropertyValue(
    ...
    const isComponentIdReferenceKey = (key) =>
...
function consumerMarkDirty(node) {
  ...
  (_a$1 = node.consumerMarkedDirty) == null
    ? void 0
    : _a$1.call(node.wrapper ?? node);
}
...
function consumerAfterComputation(node, prevConsumer) {
  ...
  if (consumerIsLive(node)) {
    for (
      let i$10 = node.nextProducerIndex;
      i$10 < node.producerNode.length;
      i$10++
    ) {
      producerRemoveLiveConsumerAtIndex(
        node.producerNode[i$10],
...
function producerAddLiveConsumer(node, consumer, indexOfThis) {
  ...
  if (node.liveConsumerNode.length === 0) {
    ...
    for (let i$10 = 0; i$10 < node.producerNode.length; i$10++) {
      node.producerIndexOfThis[i$10] = producerAddLiveConsumer(
        node.producerNode[i$10],
        node,
        i$10,
      );
...
function consumerIsLive(node) {
  ...
  return (
    ...
    (((_a$1 = node == null ? void 0 : node.liveConsumerNode) == null
      ? void 0
      : _a$1.length) ?? 0) > 0
  );
}
...
((Signal2) => {
  ...
  brand_fn = function () {};
  Signal2.isState = (s$9) =>
    typeof s$9 === "object" && __privateIn(_brand, s$9);
  Signal2.State = State;
  class Computed {
  ...
  _brand2 = new WeakSet();
  brand_fn2 = function () {};
  Signal2.isComputed = (c$7) =>
    typeof c$7 === "object" && __privateIn(_brand2, c$7);
  ...
  ((subtle2) => {
    ...
    class Watcher {
      ...
      watch(...signals) {
        ...
        __privateMethod(this, _assertSignals, assertSignals_fn).call(
          this,
          signals,
        );
      ...
      getPending() {
        ...
        return node.producerNode
          .filter((n$13) => n$13.dirty)
          .map((n$13) => n$13.wrapper);
      }
    }
    _a2 = NODE;
    _brand3 = new WeakSet();
 ...
 */ const o$9 = {
  ...
  r$7 = (t$7 = o$9, e$14, r$12) => {
    ...
    if (
      (void 0 === s$9 &&
        globalThis.litPropertyMetadata.set(i$10, (s$9 = new Map())),
      "setter" === n$13 && ((t$7 = Object.create(t$7)).wrapped = !0),
      s$9.set(r$12.name, t$7),
      "accessor" === n$13)
    ) {
      ...
      return {
        set(r$13) {
          ...
          (e$14.set.call(this, r$13),
            this.requestUpdate(o$15, n$14, t$7, !0, r$13));
        },
        init(e$15) {
  ...
  return (e$14, o$15) =>
    "object" == typeof o$15
      ...
      : ((t$8, e$15, o$16) => {
          ...
          return (
            e$15.constructor.createProperty(o$16, t$8),
            r$12 ? Object.getOwnPropertyDescriptor(e$15, o$16) : void 0
          );
        })(t$7, e$14, o$15);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const e$6 = (e$14, t$7, c$7) => (
  (c$7.configurable = !0),
  (c$7.enumerable = !0),
  Reflect.decorate &&
    "object" != typeof t$7 &&
    Object.defineProperty(e$14, t$7, c$7),
  c$7
);
      ...
      return e$6(n$13, s$9, {
        get() {
          ...
          return (
            void 0 === t$7 &&
              ((t$7 = o$15(this)),
              (null !== t$7 || this.hasUpdated) && r$13.call(this, t$7)),
            t$7
          );
        },
      });
    ...
    e$6(n$13, e$14, {
      async get() {
        return (
          ...
          this.renderRoot?.querySelector(r$12) ?? null
        );
      },
    });
}
 ...
 */ function o$8(o$15) {
  return (e$14, n$13) => {
    const { slot: r$12, selector: s$9 } = o$15 ?? {},
      c$7 = "slot" + (r$12 ? `[name=${r$12}]` : ":not([name])");
    return e$6(e$14, n$13, {
      get() {
        const t$7 = this.renderRoot?.querySelector(c$7),
          e$15 = t$7?.assignedElements(o$15) ?? [];
 ...
 */ function n$5(n$13) {
  return (o$15, r$12) => {
    const { slot: e$14 } = n$13 ?? {},
      s$9 = "slot" + (e$14 ? `[name=${e$14}]` : ":not([name])");
    return e$6(o$15, r$12, {
      get() {
...
const s$1 = new Signal.subtle.Watcher(() => {
  ...
  e$3 = new FinalizationRegistry((i$10) => {
  ...
  return !0 === i$10[h$3]
    ...
    : class extends i$10 {
        ...
        _$Sl() {
          ...
          const e$14 =
            null === (t$7 = this.h) || void 0 === t$7
              ? void 0
              : t$7
                  .getPending()
                  .filter((t$8) => t$8 !== this._$Su && !this._$St.has(t$8));
          (s$9.forEach((t$8) => t$8.get()),
            null === (i$11 = this._$Su) || void 0 === i$11 || i$11.get(),
            e$14.forEach((t$8) => t$8.get()),
            h$7.forEach((t$8) => t$8.get()));
        }
        _$Sv() {
        ...
        _$S_() {
          ...
          const i$11 = (this.h = new Signal.subtle.Watcher(function () {
            ...
            void 0 !== t$7 &&
              (!1 === t$7._$Si &&
                (new Set(this.getPending()).has(t$7._$Su)
                  ? t$7.requestUpdate()
                  : t$7._$Sv()),
              this.watch());
          }));
          (n$4.set(i$11, this),
            e$3.register(this, i$11),
            i$11.watch(this._$Su),
            i$11.watch(...Array.from(this._$St).map(([t$7]) => t$7)));
        }
        _$Sp() {
          if (void 0 === this.h) return;
          let i$11 = !1;
          (this.h.unwatch(
            ...Signal.subtle.introspectSources(this.h).filter((t$7) => {
              var s$9;
              const h$7 =
                !0 !==
                (null === (s$9 = this._$St.get(t$7)) || void 0 === s$9
                  ? void 0
                  : s$9.manualDispose);
            ...
            i$11 ||
              ((this._$Su = void 0), (this.h = void 0), this._$St.clear()));
        }
        updateEffect(i$11, s$9) {
          ...
          return (
            this.h.watch(e$14),
            this._$St.set(e$14, s$9),
            null !== (h$7 = null == s$9 ? void 0 : s$9.beforeUpdate) &&
            void 0 !== h$7 &&
            h$7
              ? Signal.subtle.untrack(() => e$14.get())
              : this.updateComplete.then(() =>
                  Signal.subtle.untrack(() => e$14.get()),
                ),
            () => {
              (this._$St.delete(e$14),
                this.h.unwatch(e$14),
...
function h$2(i$10) {
  void 0 !== this._$AN
    ? (o$6(this), (this._$AM = i$10), r$3(this))
    : (this._$AM = i$10);
}
function n$3(i$10, t$7 = !1, e$14 = 0) {
  const r$12 = this._$AH,
    h$7 = this._$AN;
  if (void 0 !== h$7 && 0 !== h$7.size)
    if (t$7)
      if (Array.isArray(r$12))
        for (let i$11 = e$14; i$11 < r$12.length; i$11++)
          (s(r$12[i$11], !1), o$6(r$12[i$11]));
...
var f = class extends i$5 {
  ...
  _$AO(i$10, t$7 = !0) {
    (i$10 !== this.isConnected &&
      ((this.isConnected = i$10),
      i$10 ? this.reconnected?.() : this.disconnected?.()),
      t$7 && (s(this, i$10), o$6(this)));
  }
  setValue(t$7) {
...
var r$2 = class extends f {
  _$S_() {
    ...
    void 0 === this._$Sm &&
      ((this._$Sj = new Signal.Computed(() => {
        var i$11;
        const t$8 =
          null === (i$11 = this._$SW) || void 0 === i$11 ? void 0 : i$11.get();
        return (this.setValue(t$8), t$8);
      })),
      (this._$Sm =
        null !==
          (t$7 =
            null === (i$10 = this._$Sk) || void 0 === i$10 ? void 0 : i$10.h) &&
        void 0 !== t$7
          ? t$7
          : n$2),
      ...
      Signal.subtle.untrack(() => {
        var i$11;
        return null === (i$11 = this._$Sj) || void 0 === i$11
          ? void 0
          : i$11.get();
      }));
  }
  _$Sp() {
    void 0 !== this._$Sm &&
      (this._$Sm.unwatch(this._$SW), (this._$Sm = void 0));
  }
  render(i$10) {
  ...
  update(i$10, [t$7]) {
    var o$15, n$13;
    return (
      (null !== (o$15 = this._$Sk) && void 0 !== o$15) ||
        (this._$Sk =
          null === (n$13 = i$10.options) || void 0 === n$13
            ? void 0
            : n$13.host),
      t$7 !== this._$SW && void 0 !== this._$SW && this._$Sp(),
      (this._$SW = t$7),
      this._$S_(),
 ...
 */ const m =
    ...
    (t$7, ...m$3) =>
      o$15(
        t$7,
        ...m$3.map((o$16) =>
          o$16 instanceof Signal.State || o$16 instanceof Signal.Computed
            ? h$1(o$16)
            : o$16,
        ),
      ),
...
var __runInitializers$19 =
  ...
  function (thisArg, initializers, value) {
    ...
    for (var i$10 = 0; i$10 < initializers.length; i$10++) {
      value = useValue
        ? initializers[i$10].call(thisArg, value)
        : initializers[i$10].call(thisArg);
    }
...
var __esDecorate$19 =
  ...
  function (
    ...
    function accept(f$4) {
      if (f$4 !== void 0 && typeof f$4 !== "function")
    ...
    for (var i$10 = decorators.length - 1; i$10 >= 0; i$10--) {
      var context = {};
      for (var p$3 in contextIn)
        context[p$3] = p$3 === "access" ? {} : contextIn[p$3];
      for (var p$3 in contextIn.access)
        context.access[p$3] = contextIn.access[p$3];
...
let Root = (() => {
  ...
  var Root$1 = class extends _classSuper {
    ...
    #weight =
      (__runInitializers$19(this, _enableCustomElements_extraInitializers), 1);
    static {
      this.styles = [
        structuralStyles,
        i$9`
 ...
 */ const e$2 = e$10(
  class extends i$5 {
    constructor(t$7) {
      if (
        (super(t$7),
        t$7.type !== t$4.ATTRIBUTE ||
          "class" !== t$7.name ||
          t$7.strings?.length > 2)
      )
        throw Error(
    ...
    update(s$9, [i$10]) {
      if (void 0 === this.st) {
        ...
        for (const t$7 in i$10)
          i$10[t$7] && !this.nt?.has(t$7) && this.st.add(t$7);
        return this.render(i$10);
      }
      const r$12 = s$9.element.classList;
      for (const t$7 of this.st)
        t$7 in i$10 || (r$12.remove(t$7), this.st.delete(t$7));
      for (const t$7 in i$10) {
        const s$10 = !!i$10[t$7];
        s$10 === this.st.has(t$7) ||
          this.nt?.has(t$7) ||
          (s$10
            ? (r$12.add(t$7), this.st.add(t$7))
            : (r$12.remove(t$7), this.st.delete(t$7)));
      }
      return E;
    }
  },
      ...
      render(t$7) {
        return Object.keys(t$7).reduce((e$14, r$12) => {
          ...
          return null == s$9
            ? e$14
            : e$14 +
                `${(r$12 = r$12.includes("-") ? r$12 : r$12.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase())}:${s$9};`;
        }, "");
      }
      update(e$14, [r$12]) {
        const { style: s$9 } = e$14.element;
        if (void 0 === this.ft)
          return ((this.ft = new Set(Object.keys(r$12))), this.render(r$12));
        for (const t$7 of this.ft)
          null == r$12[t$7] &&
            (this.ft.delete(t$7),
            t$7.includes("-") ? s$9.removeProperty(t$7) : (s$9[t$7] = null));
...
let Button = (() => {
  ...
  var Button$1 = class extends _classSuper {
    ...
    #action_accessor_storage = __runInitializers$17(
      this,
      _action_initializers,
      null,
    );
...
let Checkbox = (() => {
  ...
  var Checkbox$1 = class extends _classSuper {
    ...
    #value_accessor_storage = __runInitializers$15(
      this,
      _value_initializers,
      null,
    );
    ...
    render() {
      if (this.value && typeof this.value === "object") {
        if ("literalBoolean" in this.value && this.value.literalBoolean) {
          ...
          "literal" in this.value &&
          this.value.literal !== undefined
        ) {
...
let Column = (() => {
  ...
  var Column$1 = class extends _classSuper {
    ...
    #alignment_accessor_storage = __runInitializers$14(
      this,
      _alignment_initializers,
      "stretch",
    );
...
let DateTimeInput = (() => {
  ...
  var DateTimeInput$1 = class extends _classSuper {
    ...
    #value_accessor_storage = __runInitializers$13(
      this,
      _value_initializers,
      null,
    );
...
let Icon = (() => {
  ...
  var Icon$1 = class extends _classSuper {
    ...
    #name_accessor_storage = __runInitializers$11(
      this,
      _name_initializers,
      null,
    );
...
let List = (() => {
  ...
  var List$1 = class extends _classSuper {
    ...
    #direction_accessor_storage = __runInitializers$9(
      this,
      _direction_initializers,
      "vertical",
    );
...
let MultipleChoice = (() => {
  ...
  var MultipleChoice$1 = class extends _classSuper {
    ...
    #description_accessor_storage = __runInitializers$8(
      this,
      _description_initializers,
      null,
    );
  ...
  n = e$10(
    class extends f {
      ...
      update(i$10, [s$9]) {
        ...
        return (
          e$14 && void 0 !== this.G && this.rt(void 0),
          (e$14 || this.lt !== this.ct) &&
            ((this.G = s$9),
            (this.ht = i$10.options?.host),
            this.rt((this.ct = i$10.element))),
          A
        );
      }
      rt(t$7) {
        if ((this.isConnected || (t$7 = void 0), "function" == typeof this.G)) {
          ...
          (void 0 === s$9 && ((s$9 = new WeakMap()), o$1.set(i$10, s$9)),
            void 0 !== s$9.get(this.G) && this.G.call(this.ht, void 0),
            s$9.set(this.G, t$7),
            void 0 !== t$7 && this.G.call(this.ht, t$7));
...
let Modal = (() => {
  ...
  var Modal$1 = class extends _classSuper {
    ...
    #showModal_accessor_storage = __runInitializers$7(
      this,
      _private_showModal_initializers,
      false,
    );
...
let Row = (() => {
  ...
  var Row$1 = class extends _classSuper {
    ...
    #alignment_accessor_storage = __runInitializers$6(
      this,
      _alignment_initializers,
      "stretch",
    );
...
let Slider = (() => {
  ...
  var Slider$1 = class extends _classSuper {
    ...
    #value_accessor_storage = __runInitializers$5(
      this,
      _value_initializers,
      null,
    );
...
let Surface = (() => {
  ...
  var Surface$1 = class extends _classSuper {
    ...
    #surfaceId_accessor_storage = __runInitializers$4(
      this,
      _surfaceId_initializers,
      null,
    );
...
let Tabs = (() => {
  ...
  var Tabs$1 = class extends _classSuper {
    ...
    #titles_accessor_storage = __runInitializers$3(
      this,
      _titles_initializers,
      null,
    );
...
let TextField = (() => {
  ...
  var TextField$1 = class extends _classSuper {
    ...
    #text_accessor_storage = __runInitializers$2(
      this,
      _text_initializers,
      null,
    );
 ...
 */ var e = class extends i$5 {
  constructor(i$10) {
    if ((super(i$10), (this.it = A), i$10.type !== t$4.CHILD))
      throw Error(
  ...
  render(r$12) {
    if (r$12 === A || null == r$12)
      return ((this._t = void 0), (this.it = r$12));
    if (r$12 === E) return r$12;
    if ("string" != typeof r$12)
      throw Error(
...
function replaceCodePoint(codePoint) {
  ...
  return (_a$1 = decodeMap.get(codePoint)) !== null && _a$1 !== void 0
    ? _a$1
    : codePoint;
}
/**
...
function isHexadecimalCharacter(code$1) {
  return (
    (code$1 >= CharCodes.UPPER_A && code$1 <= CharCodes.UPPER_F) ||
    (code$1 >= CharCodes.LOWER_A && code$1 <= CharCodes.LOWER_F)
  );
}
function isAsciiAlphaNumeric(code$1) {
  return (
    (code$1 >= CharCodes.UPPER_A && code$1 <= CharCodes.UPPER_Z) ||
    (code$1 >= CharCodes.LOWER_A && code$1 <= CharCodes.LOWER_Z) ||
    isNumber(code$1)
  );
}
/**
...
(function (EntityDecoderState$1) {
  EntityDecoderState$1[(EntityDecoderState$1["EntityStart"] = 0)] =
    "EntityStart";
  EntityDecoderState$1[(EntityDecoderState$1["NumericStart"] = 1)] =
    "NumericStart";
  EntityDecoderState$1[(EntityDecoderState$1["NumericDecimal"] = 2)] =
    "NumericDecimal";
  EntityDecoderState$1[(EntityDecoderState$1["NumericHex"] = 3)] = "NumericHex";
  EntityDecoderState$1[(EntityDecoderState$1["NamedEntity"] = 4)] =
    "NamedEntity";
...
var EntityDecoder = class {
  ...
  addToNumericResult(str, start, end, base$1) {
    if (start !== end) {
      ...
      this.result =
        this.result * Math.pow(base$1, digitCount) +
        parseInt(str.substr(start, digitCount), base$1);
  ...
  emitNumericEntity(lastCp, expectedLength) {
    ...
    if (this.consumed <= expectedLength) {
      (_a$1 = this.errors) === null || _a$1 === void 0
        ? void 0
        : _a$1.absenceOfDigitsInNumericCharacterReference(this.consumed);
      return 0;
    }
  ...
  emitNotTerminatedNamedEntity() {
    ...
    (_a$1 = this.errors) === null || _a$1 === void 0
      ? void 0
      : _a$1.missingSemicolonAfterCharacterReference();
    return this.consumed;
  }
  /**
   * Emit a named entity.
...
const getCodePoint =
  String.prototype.codePointAt != null
    ...
    : (c$7, index) =>
        (c$7.charCodeAt(index) & 64512) === 55296
          ? (c$7.charCodeAt(index) - 55296) * 1024 +
            c$7.charCodeAt(index + 1) -
            56320 +
            65536
          : c$7.charCodeAt(index);
/**
...
function decodeStrict(data, options = EntityLevel.XML) {
  ...
  (_a$1 = opts.mode) !== null && _a$1 !== void 0
    ? _a$1
...
Renderer.prototype.renderAttrs = function renderAttrs(token) {
  ...
  for (i$10 = 0, l$5 = token.attrs.length; i$10 < l$5; i$10++) {
    result +=
      " " +
      escapeHtml(token.attrs[i$10][0]) +
      '="' +
      escapeHtml(token.attrs[i$10][1]) +
      '"';
  }
  return result;
};
...
function linkify$1(state) {
  ...
  for (let j$2 = 0, l$5 = blockTokens.length; j$2 < l$5; j$2++) {
    if (
      blockTokens[j$2].type !== "inline" ||
      !state.md.linkify.pretest(blockTokens[j$2].content)
    ) {
      continue;
    }
    ...
    for (let i$10 = tokens.length - 1; i$10 >= 0; i$10--) {
      ...
      if (currentToken.type === "link_close") {
        i$10--;
        while (
          tokens[i$10].level !== currentToken.level &&
          tokens[i$10].type !== "link_open"
        ) {
          i$10--;
        }
        continue;
      ...
      if (
        ...
        if (
          ...
          links[0].index === 0 &&
          i$10 > 0 &&
          tokens[i$10 - 1].type === "text_special"
        ) {
          links = links.slice(1);
        }
        ...
        blockTokens[j$2].children = tokens = arrayReplaceAt(
          tokens,
          i$10,
          nodes,
        );
    ...
    OUTER: while (pos < max) {
      ...
      if (t$7.index - 1 >= 0) {
        ...
        for (j$2 = i$10 - 1; j$2 >= 0; j$2--) {
          if (
            tokens[j$2].type === "softbreak" ||
            tokens[j$2].type === "hardbreak"
          )
            break;
          if (!tokens[j$2].content) continue;
          lastChar = tokens[j$2].content.charCodeAt(
            tokens[j$2].content.length - 1,
          );
          break;
        }
      }
...
function markTightParagraphs(state, idx) {
  ...
  for (let i$10 = idx + 2, l$5 = state.tokens.length - 2; i$10 < l$5; i$10++) {
    if (
      state.tokens[i$10].level === level &&
      state.tokens[i$10].type === "paragraph_open"
    ) {
...
function ParserBlock() {
  ...
  for (let i$10 = 0; i$10 < _rules$1.length; i$10++) {
    this.ruler.push(_rules$1[i$10][0], _rules$1[i$10][1], {
      alt: (_rules$1[i$10][2] || []).slice(),
    });
  }
}
...
function linkify(state, silent) {
  ...
  const proto = match[1];
  const link$1 = state.md.linkify.matchAtStart(
    state.src.slice(pos - proto.length),
  );
...
function postProcess(state, delimiters) {
  ...
  for (let i$10 = max - 1; i$10 >= 0; i$10--) {
    ...
    const isStrong =
      i$10 > 0 &&
      delimiters[i$10 - 1].end === startDelim.end + 1 &&
      delimiters[i$10 - 1].marker === startDelim.marker &&
      delimiters[i$10 - 1].token === startDelim.token - 1 &&
      ...
      if (!silent) {
        const code$1 =
          match[1][0].toLowerCase() === "x"
            ...
            : parseInt(match[1], 10);
        const token = state.push("text_special", "", 0);
        token.content = isValidEntityCode(code$1)
          ? fromCodePoint(code$1)
          : fromCodePoint(65533);
    ...
    for (const currentValue of input) {
      ...
      if (currentValue === n$13) {
        ...
        for (let k$1 = base; ; k$1 += base) {
          const t$7 =
            k$1 <= bias ? tMin : k$1 >= bias + tMax ? tMax : k$1 - bias;
          if (q < t$7) {
            break;
          }
          const qMinusT = q - t$7;
          const baseMinusT = base - t$7;
          output.push(
            stringFromCharCode(digitToBasic(t$7 + (qMinusT % baseMinusT), 0)),
          );
...
let Text = (() => {
  ...
  var Text$1 = class extends _classSuper {
    ...
    #text_accessor_storage = __runInitializers$1(
      this,
      _text_initializers,
      null,
    );
