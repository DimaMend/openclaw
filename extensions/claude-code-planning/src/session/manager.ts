...
// Note: Blocker detection is now AI-driven via core orchestrator
// Pattern-based detection removed in favor of assessQuestion() + retry mechanism
// See src/agents/claude-code/orchestrator.ts for the AI-driven implementation
...
function processEvent(session: ClaudeCodeSessionData, event: SessionEvent): void {
  ...
  // Note: Blocker detection is now AI-driven in onQuestion handler
  // via assessQuestion() + retry mechanism instead of pattern matching
